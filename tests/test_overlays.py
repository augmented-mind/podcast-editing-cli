...
from podcast.fcpxml import detect_frame_duration, parse_time
...
def test_detect_frame_duration_prefers_project_sequence() -> None:
    root = ET.fromstring(
        """
<fcpxml version="1.11">
  <resources>
    <format id="r1" name="NestedFormat" frameDuration="1001/24000s" />
    <format id="r2" name="ProjectFormat" frameDuration="1/30s" />
    <media id="m1" name="Nested">
  ...
  <library>
    <event name="Event">
      <project name="Project">
        <sequence format="r2"><spine /></sequence>
      </project>
    </event>
  </library>
</fcpxml>
"""
    ...
    assert detect_frame_duration(root) == Fraction(1, 30)
